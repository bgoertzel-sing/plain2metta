...
- conservative ML/time-series methodology obligations for metric declaration, horizon/frequency declaration, reproducibility evidence, train-only preprocessing fit scope, baseline comparison, and uncertainty/error-bar reporting, with missing evidence surfaced as blocking questions;
