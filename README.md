...
- PeTTa profile refusal records for `RawTextOnly`, unsupported semantic levels, unsupported predicates, non-string predicate values, malformed fact record types/arity, object-fact subject mismatches, non-string object IDs, and non-string object references;
