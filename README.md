...
- conservative security/privacy obligation scaffolding for secrets handling, secret log-exposure review, PII/privacy handling, data/sensitivity classification, retention/deletion review, data-residency/cross-border transfer review, access-boundary declarations, privilege-escalation review, and destructive-action safety review, with missing evidence surfaced as blocking questions;
