...
- first-class validation-obligation and check records (`Pass`, `Fail`, `Unknown`), including backend-safe non-blank property and target identities plus reviewable rationale/evidence checks;
