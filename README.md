...
- validation-layer self-checks that ensure validation obligations cite known source/target provenance, and each check record cites an existing obligation, uses a declared status, and matches its declared property/target;
