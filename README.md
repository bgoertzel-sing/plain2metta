...
- PeTTa profile refusal records for `RawTextOnly`, unsupported semantic levels, unsupported predicates, malformed fact arity, object-fact subject mismatches, non-string object IDs, and non-string object references;
