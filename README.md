...
- shallow requirement/test coverage obligations with Pass/Unknown checks, explicit `[id:...]`/`[covers:...]` label matching, missing-test questions, and unresolved coverage-target questions;
