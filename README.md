...
- fail-closed source-manifest link gates that suppress sections and Plain items whose files, spans, or parent sections were not emitted, or whose emitted provenance belongs to a different file;
