...
- conservative security/privacy obligation scaffolding for secrets handling, secret log-exposure review, PII/privacy handling, access-boundary declarations, and destructive-action safety review, with missing evidence surfaced as blocking questions;
