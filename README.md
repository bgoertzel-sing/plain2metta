...
- first Phase 2 semantic-object slice for conservative proposition extraction (`X is a Y`, `X has property Y`, `X must Y`, `X shall Y`), action-template extraction (`The system shall X`, `The component must Y`), source requirement links, concept cross-references, and Pass/Unknown review obligations for typed predicates, verbs, and provisional semantic links;
...
- broad or ambiguous English semantic extraction beyond the conservative Phase 2 patterns;
