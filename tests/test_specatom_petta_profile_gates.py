...
class PettaProfileGateTests(unittest.TestCase):
    ...
    def test_unicode_space_after_object_subtarget_separator_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-post-separator-em-space", "reviewed",
            "object:child:\u2003fact:0",
            "Unicode whitespace after the separator is ambiguous.",
        )
        malformed_check = CheckRecord(
            "check-post-separator-em-space",
            malformed.id,
            malformed.property,
            malformed.target_id,
            CheckStatus.FAIL,
        ...
        valid = ValidationObligation(
            "obligation-valid-post-separator-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-post-separator-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
        ...
        self.assertFalse(any(
            "obligation-post-separator-em-space" in atom
            for atom in atoms
        ))
        self.assertFalse(any(
            "check-post-separator-em-space" in atom
            for atom in atoms
        ))
        self.assertIn(
            (
                "obligation-post-separator-em-space",
                "validation-obligation-target-has-padded-object-subtarget",
            ),
            {(refusal.object_id, refusal.reason) for refusal in refusals},
        )
        ...
        self.assertNotIn("must not leak", report)
        self.assertTrue(any(
            "check-valid-post-separator-neighbor" in atom
            and "canonical target" in atom
            for atom in atoms
        ))

    def test_zero_width_space_after_object_subtarget_separator_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-post-separator-zero-width-space", "reviewed",
            "object:child:\u200bfact:0",
            "Invisible format padding after the separator is ambiguous.",
        )
        malformed_check = CheckRecord(
            "check-post-separator-zero-width-space",
            malformed.id,
            malformed.property,
            malformed.target_id,
            CheckStatus.FAIL,
        ...
        valid = ValidationObligation(
            "obligation-valid-zero-width-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-zero-width-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_zero_width_space_before_object_subtarget_separator_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-pre-separator-zero-width-space", "reviewed",
            "object:child\u200b:fact:0",
            "Invisible format padding before the separator is ambiguous.",
        )
        malformed_check = CheckRecord(
            "check-pre-separator-zero-width-space",
            malformed.id,
            malformed.property,
            malformed.target_id,
            CheckStatus.FAIL,
        ...
        valid = ValidationObligation(
            "obligation-valid-pre-zero-width-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-pre-zero-width-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_trailing_zero_width_space_in_object_subtarget_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-trailing-zero-width-space", "reviewed",
            "object:child:fact:0\u200b",
            "Invisible trailing padding is ambiguous.",
        )
        malformed_check = CheckRecord(
            "check-trailing-zero-width-space",
            malformed.id,
            malformed.property,
            malformed.target_id,
            CheckStatus.FAIL,
        ...
        valid = ValidationObligation(
            "obligation-valid-trailing-zero-width-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-trailing-zero-width-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_interior_zero_width_space_in_object_subtarget_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-interior-zero-width-space", "reviewed",
            "object:child:fact:\u200b0",
            "Invisible interior padding is ambiguous.",
        )
        malformed_check = CheckRecord(
            "check-interior-zero-width-space",
            malformed.id,
            malformed.property,
            malformed.target_id,
            CheckStatus.FAIL,
        ...
        valid = ValidationObligation(
            "obligation-valid-interior-zero-width-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-interior-zero-width-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_interior_control_in_object_subtarget_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-interior-control", "reviewed",
            "object:child:fact:\u00070",
            "Invisible control characters are ambiguous.",
        )
        malformed_check = CheckRecord(
            "check-interior-control",
            malformed.id,
            malformed.property,
            malformed.target_id,
            CheckStatus.FAIL,
        ...
        valid = ValidationObligation(
            "obligation-valid-control-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-control-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_interior_surrogate_in_object_subtarget_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-interior-surrogate", "reviewed",
            "object:child:fact:\ud8000",
            "Non-scalar Unicode surrogates are ambiguous.",
        )
        malformed_check = CheckRecord(
            "check-interior-surrogate",
            malformed.id,
            malformed.property,
            malformed.target_id,
            CheckStatus.FAIL,
        ...
        valid = ValidationObligation(
            "obligation-valid-surrogate-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-surrogate-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_interior_noncharacter_in_object_subtarget_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-interior-noncharacter", "reviewed",
            "object:child:fact:\ufdd00",
            "Reserved Unicode noncharacters are not portable identities.",
        )
        malformed_check = CheckRecord(
            "check-interior-noncharacter",
            malformed.id,
            malformed.property,
            malformed.target_id,
            CheckStatus.FAIL,
        ...
        valid = ValidationObligation(
            "obligation-valid-noncharacter-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-noncharacter-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_private_use_character_in_object_subtarget_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-private-use", "reviewed",
            "object:child:fact:\ue0000",
        ...
        valid = ValidationObligation(
            "obligation-valid-private-use-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-private-use-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_unassigned_character_in_object_subtarget_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-unassigned", "reviewed",
            "object:child:fact:\u03780",
        ...
        valid = ValidationObligation(
            "obligation-valid-unassigned-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-unassigned-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_non_nfc_object_subtarget_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-non-nfc", "reviewed",
            "object:child:cafe\u0301",
            "Canonically equivalent spellings must not create distinct identities.",
        )
        malformed_check = CheckRecord(
            "check-non-nfc",
            malformed.id,
        ...
        valid = ValidationObligation(
            "obligation-valid-nfc-neighbor", "reviewed",
            "object:child:caf\u00e9",
            "Canonical NFC target.",
        )
        valid_check = CheckRecord(
            "check-valid-nfc-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_variation_selector_object_subtarget_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        malformed = ValidationObligation(
            "obligation-variation-selector", "reviewed",
        ...
        valid = ValidationObligation(
            "obligation-valid-variation-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-variation-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
    ...
    def test_combining_mark_object_subtarget_is_not_exported_or_reported(self):
        obj = SpecObject(
            "object:child",
            Role.REQUIREMENT_OBJECT,
            SemanticLevel.TEMPLATE_PARSED,
        ...
        valid = ValidationObligation(
            "obligation-valid-combining-neighbor", "reviewed",
            "object:child:fact:0",
            "Canonical neighboring target.",
        )
        valid_check = CheckRecord(
            "check-valid-combining-neighbor",
            valid.id,
            valid.property,
            valid.target_id,
            CheckStatus.PASS,
